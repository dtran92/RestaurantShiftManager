...
public class RecyclerAdapterAssignedWeekend extends RecyclerView.Adapter<RecyclerAdapterAssignedWeekend.ViewHolder> {
    private List<Employee> empList;
    private OnEmployeeListener onEmployeeListener;
    CardView cv_emp;

    public RecyclerAdapterAssignedWeekend(List<Employee> empList, OnEmployeeListener onEmployeeListener) {
        this.empList = empList;
        this.onEmployeeListener = onEmployeeListener;
    }

    public RecyclerAdapterAssignedWeekend(List<Employee> empList) {
        this.empList = empList;
    }

    @NonNull
    @Override
    public RecyclerAdapterAssignedWeekend.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapterAssignedWeekend.ViewHolder holder, int position) {
