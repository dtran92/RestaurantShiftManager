...
public class RecyclerAdapterColourAMAvai extends RecyclerView.Adapter<RecyclerAdapterColourAMAvai.ViewHolder> {
    private List<Employee> empList;
    private OnEmployeeListener onEmployeeListener;
    CardView cv_emp;

    public RecyclerAdapterColourAMAvai(List<Employee> empList, OnEmployeeListener onEmployeeListener) {
    ...
    @NonNull
    @Override
    public RecyclerAdapterColourAMAvai.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapterColourAMAvai.ViewHolder holder, int position) {
