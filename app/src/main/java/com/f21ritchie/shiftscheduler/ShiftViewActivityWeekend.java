...
public class ShiftViewActivityWeekend extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imageButton_editWeekend.setOnClickListener(this);
        ...
        activityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
            ...
            public void onActivityResult(ActivityResult result) {
                ...
                recyclerAdapterAssignedWeekend.notifyDataSetChanged();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imageButton_editWeekend:
            Intent intent = new Intent(this, ShiftEditActivityWeekend.class);
